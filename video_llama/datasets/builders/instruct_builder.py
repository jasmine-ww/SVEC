...
from video_llama.datasets.datasets.change_caption_datasets import Change_Caption
...
class Instruct_Builder(BaseDatasetBuilder):
    ...
    def build(self):
        ...
        datasets[split] = dataset_cls(
            ...
            vis_root2=build_info.videos_dir_2,
...
class ActivitynetInstruct_Builder(Instruct_Builder):
    train_dataset_cls = Video_Instruct_Dataset
...
@registry.register_builder("change_caption")
class ChangeCaption_Builder(Instruct_Builder):
    train_dataset_cls = Change_Caption

    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/instruct/change_caption.yaml",
    }
