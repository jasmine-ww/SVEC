...
class RunnerBase:
    ...
    def setup_output_dir(self):
        ...
        wandb.init(project="videollama", name=self.job_id)
        self.save_code()

    def save_code(self):
        if not os.path.exists(os.path.join(self.output_dir, "codes")):
            os.mkdir(os.path.join(self.output_dir, "codes"))
    ...
    def train(self):
        ...
        for cur_epoch in range(self.start_epoch, self.max_epoch):
            ...
            if len(self.valid_splits) > 0:
                ...
                if not self.evaluate_only:
                    self._save_checkpoint(cur_epoch, is_best=False) #False
